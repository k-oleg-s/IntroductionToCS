...
namespace Lessons
{
 ...
 Start:           
        ...
        static void Task6(int office)
        {
            ...
            if (((int)weekDays.Monday & office) == (int)weekDays.Monday) workingDays += weekDays.Monday + " ";  // 
            if ((weekDays.Tuesday & (weekDays)office) == weekDays.Tuesday) workingDays += weekDays.Tuesday + " ";
